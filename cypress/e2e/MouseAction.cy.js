...
describe("Mouse operations", () => {
  ...
  it("Right click", () => {
    cy.visit("https://swisnl.github.io/jQuery-contextMenu/demo.html"); //approach1
  ...
  it("Drag and drop using plugins", () => {
    ...
    cy.wait(3000);
    cy.get("#box6").drag("#box106", { force: true }); //force:true - if the element is hidden it will get the element forcefully and perform action        //drag & drop plugin approach is preferrable and easier than trigger approach    })
